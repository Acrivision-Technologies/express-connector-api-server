...
export class JobArgs implements JobArgsProps, Validatable {
  ...
  constructor(props: JobArgsProps) {
    ...
    this.jobSubjectName = props.jobSubjectName;
  }
...
export class HubArgs implements HubArgsProps, Validatable {
  ...
  public get isValid(): boolean {
    if (this.briefcaseFile && !fs.existsSync(this.briefcaseFile)) {
      ...
      console.log(LoggerCategories.Framework, "HubArgs.briefcaseFile does not exist");
      return false;
    }
    // if (!this.iModelGuid) {
    //   Logger.logError(LoggerCategories.Framework, "HubArgs.iModelGuid is not defined or has invalid value");
    //   console.log(LoggerCategories.Framework, "HubArgs.iModelGuid is not defined or has invalid value");
    //   return false;
    // }
    if (!this.projectGuid) {
      Logger.logError(LoggerCategories.Framework, "HubArgs.projectGuid is not defined or has invalid value");
      console.log(LoggerCategories.Framework, "HubArgs.projectGuid is not defined or has invalid value");
      return false;
    }
    if (this.doInteractiveSignIn && !this.clientConfig) {
      ...
      console.log(LoggerCategories.Framework, "HubArgs.clientConfig must be defined if HubArgs.doInteractiveSignIn=true");
      return false;
    }
    if (!this.doInteractiveSignIn && !this.tokenCallbackUrl && !this.tokenCallback) {
      ...
      console.log(LoggerCategories.Framework, "HubArgs.tokenCallback or HubArgs.tokenCallbackUrl must be defined if HubArgs.doInteractiveSignIn=false");
      return false;
    }
    return true;
  }
